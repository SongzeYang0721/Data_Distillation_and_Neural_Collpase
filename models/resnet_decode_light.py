...
__all__ = ['LightDecoder', 'resnet18_decoder_light', 'resnet20_decoder_light']
...
def _resnet_decoder_light(
    arch: str,
    block: Type[Union[LightBasicBlockDec]],
    layers: List[int],
    pretrained: bool,
    progress: bool,
    **kwargs: Any
) -> LightDecoder:
    model = LightDecoder(block, layers, **kwargs)
    if pretrained:
        sys.exit('No pre-trained model is allowed here!')
    return model


def resnet18_decoder_light(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> LightDecoder:
    ...
    """
    return _resnet_decoder_light('resnet18_decoder', LightBasicBlockDec, [2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet34_decoder_light(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> LightDecoder:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_decoder_light('resnet20_decoder', LightBasicBlockDec, [3, 3, 3], pretrained, progress,
                   **kwargs)
