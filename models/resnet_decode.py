...
class ResNet_decoder(nn.Module):
    ...
    def __init__(
        ...
        if not fixdim:
            self.layer4 = self._make_layer(block, 32*32*3, layers[3], stride=2, output_padding = 1,
            ...
            if not SOTA:
                ...
                self.unavgpool = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=4, stride=1, padding=0, 
                                                bias=False)
            self.unnormalize = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=1, stride=1, padding=0, 
                                                bias=False)
...
def resnet18_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnet34_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnet50_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnet101_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnet152_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnext50_32x4d_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def resnext101_32x8d_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def wide_resnet50_2_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
...
def wide_resnet101_2_decoder(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_decoder:
